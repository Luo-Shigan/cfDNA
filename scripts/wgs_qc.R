...
#.libPaths()
## 检测模板区域的CpG与基因组的有没有区别
message("Load required packages ...")
suppressPackageStartupMessages(library(MEDIPS))
suppressPackageStartupMessages(library(BSgenome.Hsapiens.Gencode.GRCh38))
...
BSgenome <- 'BSgenome.Hsapiens.Gencode.GRCh38'
uniq <- 1
chr.select <- c(paste0('chr',1:1)) 
